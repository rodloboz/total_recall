defmodule TotalRecall.Accounts.User do
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, TotalRecall.Repo)
  ...
  defp validate_username(changeset) do
    ...
    |> validate_format(:username, ~r/^[a-z0-9_-]{3,15}$/)
    |> unsafe_validate_unique(:username, TotalRecall.Repo)
  ...
  """
  def valid_password?(%TotalRecall.Accounts.User{hashed_password: hashed_password}, password)
